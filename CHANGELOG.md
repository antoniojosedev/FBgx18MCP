...
- Synchronize the tool-contract regression gate with the 227-action public schema after adding `set_table_type`; the documented action-count guard now fails with an explicit update point when a future public action changes the catalog.
